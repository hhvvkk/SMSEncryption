...
\begin{tabular}{ll}
%--------------------------------
\textbf{Found in requirement}&Add User Acount : FRQ1\\
\textbf{Name of item}&User name\\
\textbf{Description of purpose}&The desired screen name of the user\\
\textbf{Source of input}&User\\
\textbf{Destination of output}&N/A\\
\textbf{Valid range, accuracy, and/or tolerance}&\\
\textbf{Relationships to other inputs/outputs}&Same as all other user names\\
&\\
%--------------------------------
\textbf{Found in requirement}&Add User Acount : FRQ1\\
\textbf{Name of item}&Password\\
\textbf{Description of purpose}&The desired password  of the user\\
\textbf{Source of input}&User\\
\textbf{Destination of output}&N/A\\
\textbf{Valid range, accuracy, and/or tolerance}&\\
\textbf{Relationships to other inputs/outputs}&Same as all other passwords\\
&\\
%--------------------------------
\textbf{Found in requirement}&Add User Acount : FRQ1\\
...
\end{itemize}
 \includegraphics[width=13cm]{diagrams/StateDiagrams/RemoveContactStateDiagram.png}
\end{itemize}
