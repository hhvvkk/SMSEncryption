...
\subsubsection{Message length : DC1\\(Source: Bernard Wagner, Priority: High)}
\begin{itemize}
...
\end{itemize}
\subsubsection{The usable character : DC2\\(Source: Bernard Wagner, Priority: High)}
\begin{itemize}
...
\end{itemize}
\subsubsection{Application resource requirementsr : DC3\\(Source: Bernard Wagner, Priority: High)}
\begin{itemize}
